    ...
    init: function(jd, n) {
        ...
        for (i = 0; i < n; i++) {
            ...
            if (n == 7)
                ...
                M = m_coord(T, -1, -1, -1);
            if (n == 3)
                S = e_coord(T, 65, 65, 65),
                M = m_coord(T, -1, 150, 150);
            if (n == 2)
                S = e_coord(T, 20, 20, 20),
                M = m_coord(T, 30, 30, 30);
    ...
    mingLiBaZi: function(jd, J, ob) {
        ...
        for (i = 0; i < 13; i++) {
            ...
            if (SC == i)
                ...
                ob.ny = this.gzny[Math.round((((60 + (v + i + 1) % 60) % 60) / 2), 0)];
            ob.bz_JS += (i ? ' ' : '') + c;
        }
    },
    ...
    calcY: function(jd) {
        ...
        if (YY >= -721 && YY <= -104) {
            ...
            for (i = 0; i < 3; i++) {
                yy = YY + i - 1;
                if (yy >= -721)
                    ns[i] = this.calc(1457698 - J2000 + int2(0.342 + (yy + 721) * 12.368422) * 29.5306, '朔'),
                    ns[i + 3] = '十三',
                    ns[i + 6] = 2;
                if (yy >= -479)
                    ns[i] = this.calc(1546083 - J2000 + int2(0.500 + (yy + 479) * 12.368422) * 29.5306, '朔'),
                    ns[i + 3] = '十三',
                    ns[i + 6] = 2;
                if (yy >= -220)
                    ns[i] = this.calc(1640641 - J2000 + int2(0.866 + (yy + 220) * 12.369000) * 29.5306, '朔'),
                    ns[i + 3] = '后九',
                    ns[i + 6] = 11;
            }
            var nn, f1;
...
function Dtlpq(pjqn) {
    ...
    var s = '';
    if (y < 1582 || y > 1644 || (y == 1644 && Cal_m.value - 0 == 12))
        return s;
...
function GJ2_pi1(fs) {
    ...
    if (fs == 4)
        a = 6,
        T = 1,
        s += '6边 T=1 补弧田p=(1+T/24)*3　 ' + st;
    if (fs == 5)
        a = 4,
        T = 2,
        s += '6边 T=1 补弧田p=(1+T/24)*2√2' + st;
