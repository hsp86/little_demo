...
function showPage(pg){
  ...
  // 以下用 '' 替代 'block' ，因为 tr 用了 'block' 会导致 colspan 不生效
  if(pg==1) page1.style.display='';// 'block';
  if(pg==2){page2.style.display=''; getNianLi(0);}// 'block'; getNianLi(0);} //年历
  if(pg==3){page3.style.display=''; tu_calc(2);}// 'block'; tu_calc(2);} //图表
...
function ML_calc(){
 ...
 Cal6.innerHTML =
     ...
     + '<font color=red  ><b>[八字]：</b></font><span id="bazi_span">'    + ob.bz_jn+'年 '+ob.bz_jy+'月 '+ob.bz_jr+'日 '+ob.bz_js+'时</span> 真太阳 <font color=red>' + ob.bz_zty+ '</font><br>'
   + '<font color=red  ><b>[纳音]：</b></font>'    + ob.bz_jnny+' '+ob.bz_jyny+' '+ob.bz_jrny+' '+ob.bz_jsny+'<br>'
   + '<font color=green><b>[纪时]：</b></font>' + ob.bz_JS + '<br>'
   + '<font color=green><b>[时标]：</b></font>' + '23　 01　 03　 05　 07　 09　 11　 13　 15　 17　 19　 21　 23';
}
